...
class _CounterScreenState extends State<CounterScreen> {
  ...
  return Scaffold(
    ...
    floatingActionButton:    CustomFloatingActions(
      increaseFn: increase, minusFn: Minus, reiFn: rei,
    ) ,
  );
  }
}
...
//añadir -1
          ...
          child: const Icon(Icons.exposure_minus_1),//widget especializado para mostrar iconos el icon
          onPressed:()=>minusFn()),

          
//reiniciar
            FloatingActionButton(
          child: const Icon(Icons.restart_alt),//widget especializado para mostrar iconos el icon
          onPressed:()=>reiFn()),
